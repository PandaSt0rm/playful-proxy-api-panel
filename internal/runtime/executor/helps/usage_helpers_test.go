...
func TestUsageReporterBuildRecordIncludesResponseServiceTier(t *testing.T) {
...
func TestUsageReporterSetTranslatedReasoningEffortPreservesClientServiceTierWhenRemoved(t *testing.T) {
	ctx := usage.WithServiceTier(context.Background(), "priority")
	reporter := NewUsageReporter(ctx, "openai", "gpt-5.4", nil)
