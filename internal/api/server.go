...
func (s *Server) registerManagementRoutes() {
	...
	mgmt.Use(s.managementAvailabilityMiddleware(), s.mgmt.Middleware())
	{
		...
		mgmt.POST("/usage/prune", s.mgmt.PruneUsageEvents)
		...
		mgmt.GET("/usage/api-key-aliases", s.mgmt.GetUsageAPIKeyAliases)
		mgmt.PUT("/usage/api-key-aliases", s.mgmt.PutUsageAPIKeyAliases)
		mgmt.DELETE("/usage/api-key-aliases", s.mgmt.DeleteUsageAPIKeyAlias)
		mgmt.DELETE("/usage/api-key-aliases/:hash", s.mgmt.DeleteUsageAPIKeyAlias)
		...
		mgmt.GET("/sync-profiles", s.mgmt.GetSyncProfiles)
		mgmt.PUT("/sync-profiles", s.mgmt.PutSyncProfiles)
		mgmt.PATCH("/sync-profiles", s.mgmt.PatchSyncProfiles)
