...
function buildDashboard(views: QuotaCredentialView[] = []) {
  return {
    ...
    refreshAll: vi.fn(),
    refreshOne: vi.fn(),
    autoRefresh: { enabled: false, setEnabled: vi.fn(), intervalMs: 300_000, setIntervalMs: vi.fn() },
  };
}
...
function claudeView(name: string, remaining: number): QuotaCredentialView {
  return {
    ...
    summary: { meters: [{ id: '5h', label: '5h window', remainingPercent: remaining }], extras: [] },
