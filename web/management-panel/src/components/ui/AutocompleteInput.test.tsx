...
describe('AutocompleteInput', () => {
  ...
  it('renders a label associated with the input via id', () => {
    render(
      <AutocompleteInput label="Model" id="model-field" value="" onChange={() => {}} options={STRING_OPTIONS} />
    );
  ...
  it('renders the placeholder when provided', () => {
    render(
      <AutocompleteInput value="" onChange={() => {}} options={STRING_OPTIONS} placeholder="Pick one" />
    );
  ...
  it('renders the hint text when provided', () => {
    const { container } = render(
      <AutocompleteInput value="" onChange={() => {}} options={STRING_OPTIONS} hint="A helpful hint" />
    );
  ...
  it('renders the error text when provided', () => {
    const { container } = render(
      <AutocompleteInput value="" onChange={() => {}} options={STRING_OPTIONS} error="Something broke" />
    );
  ...
  it('does not render a secondary label line when value and label are identical', async () => {
    const user = userEvent.setup();
    render(
      <AutocompleteInput value="" onChange={() => {}} options={[{ value: 'same', label: 'same' }]} />
    );
