# PPAP Management Panel

A single-file Web UI (React + TypeScript) for operating and troubleshooting **Playful Proxy API Panel (PPAP)** / CLIProxyAPI-compatible backends via the **Management API** (config, credentials, and logs).

[中文文档](README_CN.md)

**Main Project**: https://github.com/daishuge/playful-proxy-api-panel

**Source of truth**: this frontend now also lives in the main repository under `web/management-panel`. This standalone repository is kept during the transition.
