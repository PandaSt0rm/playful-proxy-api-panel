    ...
    <div className={styles.container}>
      ...
      <div className={styles.brandPanel}>
        <div className={styles.brandContent}>
          <span className={styles.brandWord}>{t('title.main')}</span>
          <span className={styles.brandWord}>{t('routeFoundry.modules.control')}</span>
        </div>
      </div>
      ...
      <div className={styles.formPanel}>
        {showSplash ? (
          ...
          <div ref={splashContentRef} className={styles.splashContent}>
            <img src={AIPROXY_MARK} alt="AIPROXY" className={styles.splashLogo} />
          ...
          <div className={styles.formContent}>
            {/* Logo */}
            <img src={AIPROXY_MARK} alt="AIPROXY" className={styles.logo} />
