/**
 * Sync profile API methods for the AIPROXYI config sync system.
...
export const syncApi = {
   ...
   */
  updateSyncProfileByName(name: string, value: Partial<SyncProfile>): Promise<{ status: string }> {
  ...
  /**
   * Fetch per-host sync status reported by aiproxy-sync CLIs.
