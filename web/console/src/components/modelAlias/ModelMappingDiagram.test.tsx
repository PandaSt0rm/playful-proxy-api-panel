...
import { ModelMappingDiagram, type ModelMappingDiagramRef } from './ModelMappingDiagram';
...
describe('ModelMappingDiagram', () => {
  ...
  describe('parsing and rendering', () => {
    ...
    it('drops mappings with an empty name', () => {
      render(
        <ModelMappingDiagram
          modelAlias={{ openai: [{ name: '', alias: 'orphan', fork: false }] }}
        />
      );
    ...
    it('drops mappings with an empty alias', () => {
      render(
        <ModelMappingDiagram
          modelAlias={{ openai: [{ name: 'gpt-4o', alias: '   ', fork: false }] }}
        />
      );
    ...
    it('tolerates a null mappings array for a provider', () => {
      render(
        <ModelMappingDiagram modelAlias={{ openai: null as unknown as OAuthModelAliasEntry[] }} />
      );
