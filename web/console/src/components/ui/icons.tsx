...
export function IconSidebarPlugins({ size = 20, ...props }: IconProps) {
  return (
    <svg {...sidebarSvgProps} width={size} height={size} {...props}>
      <path
        d="M9 4v3H6a2 2 0 0 0-2 2v3h3a2 2 0 1 1 0 4H4v3a2 2 0 0 0 2 2h3v-3a2 2 0 1 1 4 0v3h3a2 2 0 0 0 2-2v-3h3v-4h-3V9a2 2 0 0 0-2-2h-3V4a2 2 0 1 0-4 0Z"
        fill="currentColor"
        fillOpacity="0.12"
      />
    </svg>
...
export function IconSidebarUsage({ size = 20, ...props }: IconProps) {
  return (
    <svg {...sidebarSvgProps} width={size} height={size} {...props}>
      <path d="M4 20h16" />
      <rect x="5" y="11" width="3.5" height="7" rx="1" fill="currentColor" fillOpacity="0.12" />
      <rect x="10.25" y="6" width="3.5" height="12" rx="1" />
      <rect x="15.5" y="9" width="3.5" height="9" rx="1" fill="currentColor" fillOpacity="0.12" />
    </svg>
  );
}
...
export function IconSidebarToolingTemplates({ size = 20, ...props }: IconProps) {
  return (
    <svg {...sidebarSvgProps} width={size} height={size} {...props}>
      <path d="M4 7l4-3 4 3" />
      <path d="M4 7v10l4 3 4-3V7" fill="currentColor" fillOpacity="0.12" />
      <path d="M14 11h6" />
      <path d="M14 15h6" />
      <path d="M14 19h4" />
    </svg>
