...
function QuotaCredentialRowImpl({
  view,
  resolvedTheme,
  disabled,
  onRefresh,
}: QuotaCredentialRowProps) {
    ...
    <div className={`${styles.row} ${styles[`rowHealth_${view.health}`]}`}>
      <div className={styles.rowMain}>
        <div className={styles.rowIdentity}>
          <QuotaHealthDot
            health={view.health}
            label={t(`quota_management.health_${view.health}`)}
          />
          <span
          ...
          {hasOverflow && (
            ...
            >
              ...
              {expanded
                ...
                : t('quota_management.show_more_meters', {
                    count: meters.length - METER_PREVIEW_COUNT,
                  })}
            </button>
          )}
        </>
...
function resolveQuotaErrorMessage(
  t: TFunction,
