    ...
    <div className={styles.header}>
      ...
      <div className={styles.controlsRow}>
        ...
        <div
          ...
          role="group"
          aria-label={t('quota_management.provider_filters_label')}
        >
          {QUOTA_PROVIDER_ORDER.filter((entry) => availableProviders.has(entry.type)).map(
            (entry) => {
      ...
      <div
        ...
        role="group"
        aria-label={t('quota_management.health_filters_label')}
      >
