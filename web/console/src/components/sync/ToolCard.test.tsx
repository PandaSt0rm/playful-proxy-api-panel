...
describe('ToolCard', () => {
  ...
  describe('model filter mode switching', () => {
    it('marks the list tab as selected in list mode', () => {
      ...
      expect(screen.getByRole('tab', { name: 'Pick models' })).toHaveAttribute(
        'aria-selected',
        'true'
      );
    });
    ...
    it('marks the regex tab as selected in regex mode', () => {
      ...
      expect(screen.getByRole('tab', { name: 'Regex (advanced)' })).toHaveAttribute(
        'aria-selected',
        'true'
      );
    });
  ...
  describe('active model picker', () => {
    it('shows the placeholder text on the active model trigger when no model is set', () => {
      ...
      expect(screen.getByRole('button', { name: 'Active model' })).toHaveTextContent(
