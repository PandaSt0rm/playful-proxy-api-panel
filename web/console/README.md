# AIPROXY Management Panel

A single-file Web UI (React + TypeScript) for operating and troubleshooting **AIPROXY (AIPROXY)** / CLIProxyAPI-compatible backends via the **Management API** (config, credentials, and logs).

[中文文档](README_CN.md)

**Main Project**: https://github.com/PandaSt0rm/aiproxy

**Source of truth**: this frontend now also lives in the main repository under `web/console`. This standalone repository is kept during the transition.
